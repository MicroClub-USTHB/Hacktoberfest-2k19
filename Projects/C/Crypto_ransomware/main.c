...
void strcut(char entre[5000],char sortie[5000]){
    int i;
...
void Cryptage(const char nomFichSrc[5000], const char *nomFichDest, int clef)
{
...
void DemandeEtCrypte(char nomFich[5000])
{
	//char nomFich[300] = "";
	char *pRetour = NULL;
	int clef =10000000;
	clef=clef+(rand()%100000000);
	...
	if(nomFich[strlen(nomFich)-1]=='3')
	strcat(nomcry,"CRYPTED.mp3");
